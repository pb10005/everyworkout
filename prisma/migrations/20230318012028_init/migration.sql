...
CREATE TABLE "Maximum" (
    ...
    CONSTRAINT "Maximum_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Maximum" ADD CONSTRAINT "Maximum_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Maximum" ADD CONSTRAINT "Maximum_exerciseId_fkey" FOREIGN KEY ("exerciseId") REFERENCES "Exercise"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
